...
public class FirstPersonPlayer : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        pauseMenuObject = GameObject.Find("InGameMenuNew");
        ...
        inventoryUI.transform.localScale = playerItemController.inventoryObj.hiddenUIScale;
    ...
    void Update()
    {
        ...
        if (CanMove)
        {
            HandleMovementInput();
            HandleItems();
            if (!testingCam && !isPaused && !isUsingInventory)
                HandleMouseInput();
            if (canZoom)
                HandleZoom();
            if (canUseHeadbob)
    ...
    private void HandleInventoryUI()
    {
        if (Input.GetKeyDown(inventoryKey))
        {
            ...
            inventoryUI.transform.localScale = playerItemController.inventoryObj.visibleUIScale;
        }
